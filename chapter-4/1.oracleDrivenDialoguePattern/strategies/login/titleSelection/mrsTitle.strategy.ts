...
/**
 * Estratégia para selecionar o título 'Mrs.'
 */
export class MrsTitleStrategy implements ITitleSelectionStrategy {
    /**
     * Executa a seleção do título 'Mrs.'
     * @param interactions - Interações com a página
     * @returns Promise<void>
     */
    async execute(interactions: SignupInteractions): Promise<void> {
        return await interactions.clickCheckMrs();
    }
}